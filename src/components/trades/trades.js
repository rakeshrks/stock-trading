                      ...
                      _trades[k].map((i, ix) => {
                        ...
                        return (
                          <Row
                            ...
                            key={`trade-${ix}${time}-${price}-${amount}`}
                          >
                            <Col>
                              <span />
                              {time}
                            ...
                            <Col>
                              {amount1}
                              {typeof zeros === "string" && <em>{zeros}</em>}
                            </Col>
                          </Row>
                        );
                      })}
